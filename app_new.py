...
def edit_clean(cid):
    ...
    if request.method == 'POST':
        try:
            ...
            plan.manager_id = int(request.form['manager_id']) if request.form['manager_id'] else None
            plan.user_id = int(request.form['user_id']) if request.form['user_id'] else None
