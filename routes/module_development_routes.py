...
# Blueprint 생성
module_dev_routes_bp = Blueprint('module_dev_routes', __name__, url_prefix='/dev-modules')
...
def project_versions(project_id):
    """프로젝트 버전 관리"""
    try:
        return render_template('module_development/versions.html', project_id=project_id)
    except Exception as e:
