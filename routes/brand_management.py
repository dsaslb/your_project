...
from models_main import User, Brand, Branch, Staff, SystemLog, AIDiagnosis, ImprovementRequest
...
def get_brand_details(brand_id):
    ...
    try:
        ...
        # 개선 요청 목록
        improvements = ImprovementRequest.query.filter_by(brand_id=brand.id).order_by(
