...
from models import db, PluginCustomization, PluginDeployment, PluginAccessControl, Module, Brand, Branch, Industry
...
def get_plugin_customizations(plugin_id):
    """플러그인 커스터마이징 목록 조회"""
    try:
        target_type = request.args.get('target_type')  # industry, brand, store, user
