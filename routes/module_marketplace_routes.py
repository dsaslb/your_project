...
def module_settings(module_id):
    ...
    try:
        ...
        return render_template('module_settings.html',
                             ...
                             module_status=installation['status'],
                             module_installed_at=installation['created_at'],
                             module_activated_at=installation.get('activated_at'),
                             settings=settings)
...
def installed_modules():
    ...
    try:
        ...
        for module in installed_modules:
            module['status_info'] = status_manager.get_module_status(module['id'], current_user.id)
