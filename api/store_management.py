...
def get_store(store_id):
    ...
    try:
        ...
        # 최근 AI 진단 결과
        recent_diagnoses = AIDiagnosis.query.filter_by(store_id=store_id).order_by(AIDiagnosis.created_at.desc()).limit(5).all()
        diagnoses = []
...
def update_store(store_id):
    ...
    try:
        ...
        # 업데이트 가능한 필드들
        updatable_fields = ['name', 'address', 'phone', 'store_code', 'store_type', 'business_hours', 'capacity', 'status', 'processing_time_standard']
