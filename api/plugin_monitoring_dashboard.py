...
class PluginMonitoringDashboard:
        ...
        try:
            if plugin_optimizer:
                ...
                self.real_time_data['plugin_metrics'] = {
                    ...
                    'plugin_performance': performance_summary.get('plugin_performance', {}),
                    'system_health': performance_summary.get('system_health', {})
                }
            else:
                self.real_time_data['plugin_metrics'] = {
                    'timestamp': datetime.now().isoformat(),
    ...
    def get_plugin_details(self, plugin_name: str) -> Dict[str, Any]:
        ...
        try:
            if plugin_optimizer:
                performance_summary = plugin_optimizer.get_performance_summary()
                plugin_performance = performance_summary.get('plugin_performance', {}).get(plugin_name, {})
...
def get_performance_trends():
    ...
    try:
        ...
        if trend_type == 'all':
            ...
            data = {trend_type: trends.get(trend_type, [])}
