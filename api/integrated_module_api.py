...
def get_integrated_data(branch_id):
    ...
    try:
        ...
        integrated_data = integrated_system.get_integrated_data(branch_id, data_types)
        ...
        with central_data.lock:
            with central_data.db_path.parent / "central_data.db" as conn:
                ...
                if action == 'clock_in':
                    ...
                    if result:
                        clock_in = datetime.fromisoformat(result[0])
...
def calculate_payroll():
    ...
    try:
        ...
        base_salary = employee.get('monthly_salary', 2500000)
