        ...
        return jsonify({
            ...
            'chart_data': {
                ...
                'datasets': [
                    ...
                    {
                        'label': '주문 수',
                        'data': [item['orders'] for item in sales_data],
                        'borderColor': '#10B981',
...
def get_customer_segments_chart():
    ...
    try:
        ...
        return jsonify({
            'success': True,
            'chart_data': {
                'labels': [item['segment'] for item in segments_data],
                'datasets': [
                    {
                        'data': [item['count'] for item in segments_data],
                        'backgroundColor': [item['color'] for item in segments_data],
                        'borderWidth': 2,
                        'borderColor': '#FFFFFF'
                    }
                ]
...
def get_menu_performance_chart():
    ...
    try:
        ...
        return jsonify({
            'success': True,
            'chart_data': {
                'labels': [item['menu_name'] for item in menu_data],
                'datasets': [
                    {
                        'label': '판매량',
                        'data': [item['sales_count'] for item in menu_data],
                    ...
                    {
                        'label': '매출',
                        'data': [item['revenue'] for item in menu_data],
...
def get_hourly_traffic_chart():
    ...
    try:
        ...
        return jsonify({
            'success': True,
            'chart_data': {
                'labels': [item['hour'] for item in traffic_data],
                'datasets': [
                    {
                        'label': '고객 유입',
                        'data': [item['traffic'] for item in traffic_data],
                    ...
                    {
                        'label': '주문 수',
                        'data': [item['orders'] for item in traffic_data],
