...
import logging
import json
from models import User, Brand, Branch, SystemLog, db
...
class AttendanceRecord:
    """출퇴근 기록 클래스"""
    def __init__(self, user_id: int, date: str, clock_in: str = None, 
...
class AttendanceSettings:
    """출퇴근 설정 클래스"""
    def __init__(self, brand_id: int, branch_id: int = None):
...
def get_attendance_settings(brand_id: int, branch_id: int = None) -> AttendanceSettings:
    """출퇴근 설정 조회"""
