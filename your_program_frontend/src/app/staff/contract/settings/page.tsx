...
export default function ContractSettingsPage() {
  ...
  useEffect(() => {
    ...
    // 직책 목록 불러오기
    const savedPositions = localStorage.getItem('your_programPositions');
    if (savedPositions) {
      ...
      localStorage.setItem('your_programPositions', JSON.stringify(defaultPositions));
    }
  }, []);
  ...
  const addPosition = () => {
    ...
    if (position && !positions.includes(position)) {
      ...
      localStorage.setItem('your_programPositions', JSON.stringify(updatedPositions));
      setNewPosition("");
    }
  };
