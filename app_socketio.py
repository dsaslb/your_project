...
# 모델 임포트
from models_integrated import (ActionLog, Attendance, AttendanceReport,
...
def admin_reports():
    ...
    try:
        ...
        return render_template(
            "admin_reports.html", reports=reports, assignees=assignees
        )
...
def auto_process_reports():
    ...
    try:
        ...
        overdue = AttendanceReport.query.filter(
            and_(AttendanceReport.status == "pending", AttendanceReport.sla_due < now)
        ).all()
