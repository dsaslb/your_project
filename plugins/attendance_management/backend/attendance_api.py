...
def check_out():
    ...
    try:
        ...
        # 근무 시간 계산
        work_hours = attendance_service.calculate_work_hours(employee_id, check_out_time)
...
def get_attendance_report(user_type):
    ...
    try:
        ...
        # 데이터 조회
        report_data = attendance_service.get_attendance_data(user_id, user_type, start_date, end_date)
