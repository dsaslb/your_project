...
class PluginSchemaValidator:
    ...
    def validate_plugin_config(self, config: Dict) -> tuple[bool, List[str]]:
        """플러그인 설정 검증"""
        errors = []
    ...
    def _validate_additional_rules(self, config: Dict) -> List[str]:
        """추가 검증 규칙"""
        errors = []
        ...
        menu_paths = [menu.get('path') for menu in menus]
    ...
    def create_plugin_template(self, plugin_name: str, **kwargs) -> Dict:
        """플러그인 템플릿 생성"""
    ...
    def update_plugin_config(self, config: Dict, updates: Dict) -> Dict:
        """플러그인 설정 업데이트"""
...
class PluginManifest:
    ...
    def create_new(self, plugin_name: str, **kwargs) -> Dict:
        """새 매니페스트 생성"""
