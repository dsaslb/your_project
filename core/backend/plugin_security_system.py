...
class PluginSecuritySystem:
    ...
    def __init__(self, security_dir: str = "plugin_security"):
    ...
    def create_security_policy(self, plugin_id: str, policy_data: Dict) -> bool:
        """보안 정책 생성"""
        try:
    ...
    def log_security_event(self, plugin_id: str, user_id: Optional[str], action: str, resource: str, ip_address: str, user_agent: str, success: bool, details: Optional[Dict] = None) -> bool:
        """보안 이벤트 로깅"""
        try:
    ...
    def scan_plugin_vulnerabilities(self, plugin_id: str) -> List[Dict]:
        ...
        try:
            ...
            # 설정 파일 보안 스캔
            config_files = list(plugin_dir.glob("**/*.json")) + list(plugin_dir.glob("**/*.yaml")) + list(plugin_dir.glob("**/*.yml"))
    ...
    def get_vulnerabilities(self, plugin_id: Optional[str] = None, severity: Optional[str] = None, status: Optional[str] = None) -> List[Dict]:
        """취약점 보고서 조회"""
        try:
