...
class Feedback(db.Model):
    ...
    def __repr__(self):
        return f'<Feedback {self.user_id}>'
...
class ApproveLog(db.Model):
    ...
    # 복합 인덱스 추가
    __table_args__ = (
        db.Index('idx_approvelog_user_admin', 'user_id', 'admin_id'),
        db.Index('idx_approvelog_action_date', 'action', 'timestamp'),
    )

    def __repr__(self):
        return f'<ApproveLog {self.user_id} {self.action}>'
...
class ShiftRequest(db.Model):
    ...
    # 복합 인덱스 추가
    __table_args__ = (
        db.Index('idx_shiftrequest_user_date', 'user_id', 'desired_date'),
        db.Index('idx_shiftrequest_status_date', 'status', 'created_at'),
    )

    def __repr__(self):
        return f'<ShiftRequest {self.user_id} {self.desired_date}>'
...
class Notice(db.Model):
    ...
    __table_args__ = (
        ...
        db.Index('idx_notice_category_hidden', 'category', 'is_hidden'),
    )
...
class NoticeRead(db.Model):
    ...
    # 복합 인덱스 추가
    __table_args__ = (
        db.Index('idx_noticeread_notice_user', 'notice_id', 'user_id'),
        db.Index('idx_noticeread_user_date', 'user_id', 'read_at'),
    )
...
class NoticeComment(db.Model):
    ...
    # 복합 인덱스 추가
    __table_args__ = (
        db.Index('idx_noticecomment_notice_date', 'notice_id', 'created_at'),
        db.Index('idx_noticecomment_user_hidden', 'user_id', 'is_hidden'),
    )

    def __repr__(self):
        return f'<NoticeComment {self.notice_id} {self.user_id}>'
...
class NoticeHistory(db.Model):
    ...
    # 복합 인덱스 추가
    __table_args__ = (
        db.Index('idx_noticehistory_notice_action', 'notice_id', 'action'),
        db.Index('idx_noticehistory_editor_date', 'editor_id', 'edited_at'),
    )
...
class CommentHistory(db.Model):
    ...
    # 복합 인덱스 추가
    __table_args__ = (
        db.Index('idx_commenthistory_comment_action', 'comment_id', 'action'),
        db.Index('idx_commenthistory_editor_date', 'editor_id', 'edited_at'),
    )
...
class Report(db.Model):
    ...
    # 복합 인덱스 추가
    __table_args__ = (
        db.Index('idx_report_target_type_id', 'target_type', 'target_id'),
        db.Index('idx_report_status_date', 'status', 'created_at'),
        db.Index('idx_report_reporter_date', 'user_id', 'created_at'),
    )
...
class Suggestion(db.Model):
    ...
    # 복합 인덱스 추가
    __table_args__ = (
        db.Index('idx_suggestion_user_date', 'user_id', 'created_at'),
        db.Index('idx_suggestion_anonymous_date', 'is_anonymous', 'created_at'),
    )

    def __repr__(self):
        return f'<Suggestion {self.user_id}>'
...
class Schedule(db.Model):
    ...
    def __repr__(self):
        return f'<Schedule {self.user_id} {self.date}>'
...
class CleaningPlan(db.Model):
    ...
    def __repr__(self):
        return f'<CleaningPlan {self.date} {self.team}>'
...
class AttendanceEvaluation(db.Model):
    ...
    # 복합 인덱스 추가
    __table_args__ = (
        db.Index('idx_attendanceeval_user_period', 'user_id', 'date_from', 'date_to'),
        db.Index('idx_attendanceeval_evaluator_date', 'evaluator_id', 'created_at'),
    )
    
    def __repr__(self):
        return f'<AttendanceEvaluation {self.user_id} {self.date_from}-{self.date_to}>'
...
class ReasonEditLog(db.Model):
    ...
    # 복합 인덱스
    __table_args__ = (
        db.Index('idx_reasoneditlog_attendance_date', 'attendance_id', 'edited_at'),
        db.Index('idx_reasoneditlog_editor_date', 'edited_by', 'edited_at'),
    )
...
class Excuse(db.Model):
    ...
    __table_args__ = (
        ...
        db.Index('idx_excuse_priority_date', 'priority', 'created_at'),
...
class ExcuseResponse(db.Model):
    ...
    __table_args__ = (
        ...
        db.Index('idx_excuseresponse_responder_type', 'responder_id', 'response_type'),
    )
    
    def __repr__(self):
        return f'<ExcuseResponse {self.excuse_id} {self.response_type}>'
