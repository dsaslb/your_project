// Feather Icons 대체 라이브러리 - 기본 아이콘 기능 제공
const feather = {
    icons: {
        ...
        'search': '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><path d="M21 21l-4.35-4.35"></path></svg>',
    ...
    replace: function(options = {}) {
        ...
        elements.forEach(element => {
            ...
            if (this.icons[iconName]) {
                ...
                // 크기 설정
                const size = element.getAttribute('data-size') || options.size || '24';
                ...
                // 색상 설정
                const color = element.getAttribute('data-color') || options.color || 'currentColor';
                const paths = element.querySelectorAll('path, line, polyline, polygon, circle, rect, ellipse');
                paths.forEach(path => {
