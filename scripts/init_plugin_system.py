...
def init_plugin_system():
    ...
    try:
        ...
        try:
            ...
            plugin_registry_module = importlib.import_module(
                "core.backend.plugin_registry"
            )
        ...
        try:
            ...
            plugin_marketplace_module = importlib.import_module(
                "core.backend.plugin_marketplace"
            )
            available_plugins = (
                plugin_marketplace_module.plugin_marketplace.get_available_plugins()
            )
        ...
        try:
            ...
            plugin_security_module = importlib.import_module(
                "core.backend.plugin_security"
            )
            security_status = (
                plugin_security_module.plugin_security.get_security_status()
            )
