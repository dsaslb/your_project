import os
from models import AuditLog, EventLog, NotificationLog
...
def check_services():
    ...
    running = os.popen("ps aux | grep 'python' | grep -E 'app.py|auto_admin_alerts|event_auto_detector' | grep -v grep").read()
