...
class PluginMonitoringDeploymentTester:
    ...
    def test_monitoring_data_collection(self) -> Dict[str, Any]:
        ...
        try:
            # 메트릭 수집 API 호출
            response = requests.post(f"{self.base_url}/api/admin/plugin-monitoring/collect-metrics", 
                                   timeout=30)
    ...
    def test_monitoring_alerts(self) -> Dict[str, Any]:
        ...
        try:
            ...
            response = requests.post(f"{self.base_url}/api/admin/plugin-monitoring/alerts/config", 
                                   json=alert_config, timeout=10)
    ...
    def test_monitoring_dashboard(self) -> Dict[str, Any]:
        ...
        try:
            # 대시보드 데이터 요청
            response = requests.get(f"{self.base_url}/api/admin/plugin-monitoring/dashboard", timeout=10)
    ...
    def test_monitoring_performance(self) -> Dict[str, Any]:
        ...
        try:
            # 성능 테스트 API 호출
            response = requests.post(f"{self.base_url}/api/admin/plugin-monitoring/performance-test", 
                                   timeout=60)
