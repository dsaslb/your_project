...
class PluginTemplateGenerator:
    ...
    def generate_plugin_structure(self, plugin_id: str, industry: str, 
                                author: str = "Developer", version: str = "1.0.0") -> bool:
        """플러그인 구조 생성"""
        try:
            ...
            # 기본 파일 구조 생성
            self._create_backend_structure(plugin_path, plugin_id, template_info, author, version)
            self._create_frontend_structure(plugin_path, plugin_id, template_info)
            self._create_config_structure(plugin_path, plugin_id, template_info, author, version)
    ...
    def _create_backend_structure(self, plugin_path: Path, plugin_id: str, 
                                template_info: Dict, author: str, version: str):
        """백엔드 구조 생성"""
...
'''
    ...
    def _create_frontend_structure(self, plugin_path: Path, plugin_id: str, template_info: Dict):
        """프론트엔드 구조 생성"""
    ...
    def _create_config_structure(self, plugin_path: Path, plugin_id: str, 
                               template_info: Dict, author: str, version: str):
        """설정 파일 구조 생성"""
    ...
    def _create_docs_structure(self, plugin_path: Path, plugin_id: str, template_info: Dict):
        """문서 구조 생성"""
...
"""
    ...
    def _generate_main_py(self, plugin_id: str, template_info: Dict, author: str, version: str) -> str:
        """main.py 파일 내용 생성"""
...
def main():
    ...
    if not generator.validate_plugin_id(plugin_id):
        print("❌ 잘못된 플러그인 ID입니다. 영문자, 숫자, 하이픈, 언더스코어만 사용 가능합니다.")
        return
