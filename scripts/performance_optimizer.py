...
class PerformanceOptimizer:
    ...
    def optimize_sqlite_db(self, db_path: str):
        ...
        try:
            ...
            # 설정 최적화
            cursor.execute("PRAGMA cache_size = ?", (self.optimization_rules['database']['cache_size'],))
            cursor.execute("PRAGMA temp_store = ?", (self.optimization_rules['database']['temp_store'],))
            ...
            if os.path.exists(last_vacuum_file):
                ...
                if datetime.now() - last_vacuum > timedelta(hours=self.optimization_rules['database']['vacuum_interval']):
                    should_vacuum = True
            else:
                should_vacuum = True
    ...
    def cleanup_logs(self):
        ...
        try:
            ...
            max_size = self.optimization_rules['logging']['max_file_size'] * 1024 * 1024  # MB to bytes
    ...
    def generate_performance_report(self) -> Dict:
        ...
        try:
            ...
            report = {
                ...
                'alerts': self.check_performance_alerts(metrics_list[-1]) if metrics_list else []
            }
...
def main():
    ...
    if len(sys.argv) > 1:
        ...
        if command == 'optimize':
            ...
            print("사용법: python performance_optimizer.py [optimize|metrics|report|monitor]")
    else:
        # 기본 실행: 한 번 최적화
        optimizer.run_optimization_cycle()
