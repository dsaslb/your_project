...
class PerformanceTester:
    ...
    def run_comprehensive_test(self) -> Dict[str, Any]:
        ...
        test_cases = [
            ...
            {"endpoint": "/api/plugin-system/health", "method": "GET", "iterations": 10},
            {"endpoint": "/api/performance/health", "method": "GET", "iterations": 10},
            {"endpoint": "/api/auth/login", "method": "POST", 
             "data": {"username": "admin", "password": "admin123"}, "iterations": 5},
        ]
        ...
        for test_case in test_cases:
            ...
            all_response_times.extend([r for r in result["response_times"].values() if r > 0])
            
            # 결과 출력
            logger.info(f"✅ {result['endpoint']}: {result['performance_grade']} "
        ...
        overall_stats = {
            ...
            "overall_success_rate": (total_success / (total_success + total_errors)) * 100 if (total_success + total_errors) > 0 else 0,
