...
def init_feedback():
    ...
    if len(created_feedbacks) > 0:
        feedback_system.update_feedback_status(created_feedbacks[0], "in_review", "검토를 시작합니다.")
        feedback_system.update_feedback_status(created_feedbacks[1], "approved", "개발 승인되었습니다.")
        feedback_system.update_feedback_status(created_feedbacks[2], "in_development", "버그 수정을 시작합니다.")
        feedback_system.update_feedback_status(created_feedbacks[3], "in_review", "UI 개선 검토를 시작합니다.")
