...
class TestModuleMarketplaceBasic(unittest.TestCase):
    ...
    def test_sample_module_creation(self):
        ...
        attendance_module = {
            ...
            "features": ["출퇴근 기록", "근태 분석", "AI 예측", "알림 시스템"],
            "dependencies": [],
    ...
    def test_module_installation_simulation(self):
        ...
        install_file = (
            ...
            / "installed"
            / f"{self.test_user_id}_{self.test_scope_id}_branch.json"
        )
    ...
    def test_module_config_management(self):
        ...
        config_file = (
            self.marketplace_dir
            / "configs"
            / f"attendance_management_{self.test_user_id}_{self.test_scope_id}.json"
        )
    ...
    def test_module_statistics(self):
        ...
        statistics = {
            ...
            "total_activated": 2,
            "total_deactivated": 1,
            "category_distribution": {"hr": 2, "sales": 1, "inventory": 0},
            "popular_modules": [
