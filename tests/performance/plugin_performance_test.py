...
class PluginPerformanceUser(HttpUser):
    ...
    def test_plugin_restart(self):
        """플러그인 재시작 API 테스트"""
        plugin_name = random.choice(
            ["your_program_management", "analytics", "automation"]
        )
    ...
    def test_plugin_configuration(self):
        ...
        config_data = {
            ...
            "alert_thresholds": {"cpu": 80, "memory": 85, "response_time": 2000},
        }
    ...
    def test_plugin_import(self):
        """플러그인 가져오기 API 테스트"""
        import_data = {"plugin_data": "base64_encoded_plugin_data", "overwrite": False}
