...
class TestUserManagementAPI:
    ...
    def test_get_users_success(self, client, auth_headers):
        ...
        from models_main import Brand, User, db
        ...
        response = client.get("/api/modules/user/users", headers=auth_headers(token))
...
class TestNotificationAPI:
    ...
    def test_get_notifications_success(self, client, test_user, auth_headers):
        ...
        response = client.get(
            "/api/modules/notification/notifications", headers=auth_headers(token)
        )
...
class TestScheduleAPI:
    ...
    def test_get_schedules_success(self, client, test_user, auth_headers):
        ...
        response = client.get(
            "/api/modules/schedule/schedules", headers=auth_headers(token)
        )
