...
def test_auto_daily_report():
    ...
    """
    result = subprocess.run(['python', 'scripts/auto_daily_report.py'], capture_output=True, text=True)
...
def test_auto_weekly_report():
    ...
    """
    result = subprocess.run(['python', 'scripts/auto_weekly_report.py'], capture_output=True, text=True)
