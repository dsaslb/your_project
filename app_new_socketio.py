...
def m_attendance_history():
    ...
    try:
        ...
        return render_template('mobile/m_attendance_history.html',
                             attendances=attendances)
...
def m_attendance_report(att_id):
    ...
    try:
        ...
        return render_template('mobile/m_attendance_report.html',
...
def m_admin_attendance_reports():
    ...
    try:
        ...
        reports = AttendanceReport.query\
...
def m_admin_attendance_report_reply(report_id):
    ...
    try:
        ...
        return render_template('mobile/m_admin_attendance_report_reply.html',
                             report=report)
