          ...
          children: [
            {
              ...
              status: getMenuStatus('/admin-dashboard'),
              statusMessage: getStatusMessage('/admin-dashboard'),
              lastUpdated: systemStatus.lastUpdated,
            },
            {
              title: '업종별 관리',
              ...
              roles: ['super_admin'],
              category: 'administration',
              status: getMenuStatus('/industry-management'),
              statusMessage: getStatusMessage('/industry-management'),
              lastUpdated: systemStatus.lastUpdated,
            },
            {
              title: '브랜드별 관리',
              ...
              roles: ['super_admin'],
              category: 'administration',
              status: getMenuStatus('/brand-management'),
              statusMessage: getStatusMessage('/brand-management'),
              lastUpdated: systemStatus.lastUpdated,
            },
            {
              title: '매장별 관리',
              ...
              roles: ['super_admin'],
              category: 'administration',
              status: getMenuStatus('/store-management'),
              statusMessage: getStatusMessage('/store-management'),
              lastUpdated: systemStatus.lastUpdated,
            },
            {
              title: '직원별 관리',
              ...
              roles: ['super_admin'],
              category: 'administration',
              status: getMenuStatus('/employee-management'),
              statusMessage: getStatusMessage('/employee-management'),
              lastUpdated: systemStatus.lastUpdated,
            }
          ],
          roles: ['super_admin'],
      ...
      baseItems.push(
        {
          ...
          children: [
               ...
               category: 'brand',
               status: getMenuStatus('/brand-dashboard'),
               statusMessage: getStatusMessage('/brand-dashboard'),
               lastUpdated: systemStatus.lastUpdated,
             },
                         {
               title: '브랜드별 매출',
               ...
               roles: ['super_admin', 'brand_manager'],
               category: 'brand',
               status: getMenuStatus('/brand-dashboard/sales'),
               statusMessage: getStatusMessage('/brand-dashboard/sales'),
               lastUpdated: systemStatus.lastUpdated,
             },
             {
               title: '브랜드별 개선요청',
               href: '/brand-dashboard/improvements',
               roles: ['super_admin', 'brand_manager'],
               category: 'brand',
               status: getMenuStatus('/brand-dashboard/improvements'),
               statusMessage: getStatusMessage('/brand-dashboard/improvements'),
               lastUpdated: systemStatus.lastUpdated,
             }
          ],
          roles: ['super_admin', 'brand_manager'],
