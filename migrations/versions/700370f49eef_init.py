...
Revision ID: 700370f49eef
Revises:
Create Date: 2025-06-29 15:36:21.859301
...
def upgrade():
    ...
    with op.batch_alter_table("users", schema=None) as batch_op:
        ...
        batch_op.create_index(
            batch_op.f("ix_users_locked_until"), ["locked_until"], unique=False
        )
    ...
    with op.batch_alter_table("restaurant_orders", schema=None) as batch_op:
        ...
        batch_op.create_index(
            batch_op.f("ix_restaurant_orders_completed_at"),
            ["completed_at"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_restaurant_orders_created_at"), ["created_at"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_restaurant_orders_employee_id"),
            ["employee_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_restaurant_orders_order_number"),
            ["order_number"],
            unique=True,
        )
        batch_op.create_index(
            batch_op.f("ix_restaurant_orders_processing_minutes"),
            ["processing_minutes"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_restaurant_orders_status"), ["status"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_restaurant_orders_store_id"), ["store_id"], unique=False
        )
