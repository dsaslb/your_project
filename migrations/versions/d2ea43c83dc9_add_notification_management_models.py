...
def downgrade():
    ...
    with op.batch_alter_table('permission_change_logs', schema=None) as batch_op:
        batch_op.create_index('ix_permission_change_logs_user_id', ['user_id'], unique=False)
        batch_op.create_index('ix_permission_change_logs_created_at', ['created_at'], unique=False)
        batch_op.create_index('ix_permission_change_logs_changed_by', ['changed_by'], unique=False)
        batch_op.create_index('ix_permission_change_logs_change_type', ['change_type'], unique=False)
    ...
    with op.batch_alter_table('restaurant_orders', schema=None) as batch_op:
        batch_op.create_index('ix_restaurant_orders_store_id', ['store_id'], unique=False)
        batch_op.create_index('ix_restaurant_orders_status', ['status'], unique=False)
        batch_op.create_index('ix_restaurant_orders_processing_minutes', ['processing_minutes'], unique=False)
        batch_op.create_index('ix_restaurant_orders_order_number', ['order_number'], unique=1)
        batch_op.create_index('ix_restaurant_orders_employee_id', ['employee_id'], unique=False)
        batch_op.create_index('ix_restaurant_orders_created_at', ['created_at'], unique=False)
        batch_op.create_index('ix_restaurant_orders_completed_at', ['completed_at'], unique=False)
