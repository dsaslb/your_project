...
def upgrade():
    ...
    with op.batch_alter_table('users', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_users_brand_id'), ['brand_id'], unique=False)
    ...
    with op.batch_alter_table('approval_workflows', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_approval_workflows_approved_at'), ['approved_at'], unique=False)
        ...
        batch_op.create_index(batch_op.f('ix_approval_workflows_rejected_at'), ['rejected_at'], unique=False)
        batch_op.create_index(batch_op.f('ix_approval_workflows_requester_id'), ['requester_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_approval_workflows_status'), ['status'], unique=False)
        batch_op.create_index(batch_op.f('ix_approval_workflows_target_id'), ['target_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_approval_workflows_target_type'), ['target_type'], unique=False)
        batch_op.create_index(batch_op.f('ix_approval_workflows_workflow_type'), ['workflow_type'], unique=False)
    ...
    with op.batch_alter_table('branches', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_branches_brand_id'), ['brand_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_branches_created_at'), ['created_at'], unique=False)
        batch_op.create_index(batch_op.f('ix_branches_status'), ['status'], unique=False)

    op.create_table('brand_data_collections',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    with op.batch_alter_table('brand_data_collections', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_brand_data_collections_brand_id'), ['brand_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_brand_data_collections_collection_date'), ['collection_date'], unique=False)
        batch_op.create_index(batch_op.f('ix_brand_data_collections_created_at'), ['created_at'], unique=False)
        batch_op.create_index(batch_op.f('ix_brand_data_collections_data_type'), ['data_type'], unique=False)
    ...
    with op.batch_alter_table('permission_templates', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_permission_templates_created_by'), ['created_by'], unique=False)
        batch_op.create_index(batch_op.f('ix_permission_templates_role_type'), ['role_type'], unique=False)

    op.create_table('reason_templates',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('text', sa.String(length=100), nullable=False, comment='사유 텍스트'),
    sa.Column('team', sa.String(length=30), nullable=True, comment='팀별 템플릿(옵션)'),
    sa.Column('status', sa.String(length=20), nullable=True, comment='승인 상태: pending/approved/rejected'),
    sa.Column('is_active', sa.Boolean(), nullable=True, comment='활성화 여부'),
    ...
    with op.batch_alter_table('user_permissions', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_user_permissions_permission_name'), ['permission_name'], unique=False)
    ...
    with op.batch_alter_table('ai_diagnoses', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_ai_diagnoses_brand_id'), ['brand_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_ai_diagnoses_created_at'), ['created_at'], unique=False)
        batch_op.create_index(batch_op.f('ix_ai_diagnoses_diagnosis_type'), ['diagnosis_type'], unique=False)
        batch_op.create_index(batch_op.f('ix_ai_diagnoses_implemented_at'), ['implemented_at'], unique=False)
        batch_op.create_index(batch_op.f('ix_ai_diagnoses_implemented_by'), ['implemented_by'], unique=False)
        batch_op.create_index(batch_op.f('ix_ai_diagnoses_priority'), ['priority'], unique=False)
        batch_op.create_index(batch_op.f('ix_ai_diagnoses_reviewed_at'), ['reviewed_at'], unique=False)
        batch_op.create_index(batch_op.f('ix_ai_diagnoses_reviewed_by'), ['reviewed_by'], unique=False)
        batch_op.create_index(batch_op.f('ix_ai_diagnoses_severity'), ['severity'], unique=False)
        batch_op.create_index(batch_op.f('ix_ai_diagnoses_status'), ['status'], unique=False)
        batch_op.create_index(batch_op.f('ix_ai_diagnoses_store_id'), ['store_id'], unique=False)
    ...
    with op.batch_alter_table('excuses', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_excuses_attendance_evaluation_id'), ['attendance_evaluation_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_excuses_attendance_report_id'), ['attendance_report_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_excuses_created_at'), ['created_at'], unique=False)
        batch_op.create_index(batch_op.f('ix_excuses_priority'), ['priority'], unique=False)
        batch_op.create_index(batch_op.f('ix_excuses_reviewed_at'), ['reviewed_at'], unique=False)
        batch_op.create_index(batch_op.f('ix_excuses_reviewed_by'), ['reviewed_by'], unique=False)
        batch_op.create_index(batch_op.f('ix_excuses_status'), ['status'], unique=False)
        batch_op.create_index(batch_op.f('ix_excuses_user_id'), ['user_id'], unique=False)
    ...
    with op.batch_alter_table('improvement_requests', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_improvement_requests_brand_id'), ['brand_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_improvement_requests_category'), ['category'], unique=False)
        batch_op.create_index(batch_op.f('ix_improvement_requests_created_at'), ['created_at'], unique=False)
        batch_op.create_index(batch_op.f('ix_improvement_requests_priority'), ['priority'], unique=False)
        batch_op.create_index(batch_op.f('ix_improvement_requests_requester_id'), ['requester_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_improvement_requests_reviewed_at'), ['reviewed_at'], unique=False)
        batch_op.create_index(batch_op.f('ix_improvement_requests_reviewed_by'), ['reviewed_by'], unique=False)
        batch_op.create_index(batch_op.f('ix_improvement_requests_status'), ['status'], unique=False)
        batch_op.create_index(batch_op.f('ix_improvement_requests_store_id'), ['store_id'], unique=False)
    ...
    op.create_table('store_data_collections',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('store_id', sa.Integer(), nullable=False),
    sa.Column('data_type', sa.String(length=50), nullable=False),
    sa.Column('collection_date', sa.Date(), nullable=False),
    ...
    with op.batch_alter_table('store_data_collections', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_store_data_collections_collection_date'), ['collection_date'], unique=False)
        batch_op.create_index(batch_op.f('ix_store_data_collections_created_at'), ['created_at'], unique=False)
        batch_op.create_index(batch_op.f('ix_store_data_collections_data_type'), ['data_type'], unique=False)
        batch_op.create_index(batch_op.f('ix_store_data_collections_store_id'), ['store_id'], unique=False)
    ...
    with op.batch_alter_table('system_health', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_system_health_brand_id'), ['brand_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_system_health_created_at'), ['created_at'], unique=False)
        batch_op.create_index(batch_op.f('ix_system_health_health_date'), ['health_date'], unique=False)
        batch_op.create_index(batch_op.f('ix_system_health_store_id'), ['store_id'], unique=False)

    op.create_table('ai_improvement_suggestions',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    with op.batch_alter_table('ai_improvement_suggestions', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_ai_improvement_suggestions_brand_id'), ['brand_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_ai_improvement_suggestions_created_at'), ['created_at'], unique=False)
        batch_op.create_index(batch_op.f('ix_ai_improvement_suggestions_diagnosis_id'), ['diagnosis_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_ai_improvement_suggestions_reviewed_at'), ['reviewed_at'], unique=False)
        batch_op.create_index(batch_op.f('ix_ai_improvement_suggestions_reviewed_by'), ['reviewed_by'], unique=False)
        batch_op.create_index(batch_op.f('ix_ai_improvement_suggestions_status'), ['status'], unique=False)
        batch_op.create_index(batch_op.f('ix_ai_improvement_suggestions_store_id'), ['store_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_ai_improvement_suggestions_suggestion_type'), ['suggestion_type'], unique=False)
    ...
    with op.batch_alter_table('health_certificates', schema=None) as batch_op:
        batch_op.create_index('idx_healthcertificate_expired_notification', ['expiry_date', 'expired_notification_sent'], unique=False)
        batch_op.create_index('idx_healthcertificate_expiry_notification', ['expiry_date', 'notification_sent'], unique=False)
