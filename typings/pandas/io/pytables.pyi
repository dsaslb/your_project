...
class DataCol(IndexCol):
    ...
    def convert(
        self, values: np.ndarray, nan_rep, encoding: str, errors: str
    ):  # -> tuple[Any | None, ndarray[Any, Any] | NDArray[Any] | Categorical | Any | ndarray[Any, dtype[Any]]]:
        """
        Convert the data from this selection to the appropriate pandas type.
...
class GenericFixed(Fixed):
    ...
    ):  # -> ExtensionArray | Any | ndarray[Any, Any] | NDArray[Any]:
...
class Table(Fixed):
    ...
    def __init__(
        ...
        encoding: str | None = ...,
        errors: str = ...,
        index_axes: list[IndexCol] | None = ...,
        non_index_axes: list[tuple[AxisInt, Any]] | None = ...,
        values_axes: list[DataCol] | None = ...,
...
class Selection:
    ...
    def select_coords(
        self,
    ):  # -> Any | ndarray[_Shape, dtype[Any]] | NDArray[Any] | _Array1D[Any]:
        """
        generate the selection
        """
        ...
