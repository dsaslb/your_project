...
def pandasSQL_builder(
    con, schema: str | None = ..., need_transaction: bool = ...
) -> PandasSQL:
    """
...
class SQLTable(PandasObject):
    ...
    def read(
        ...
        columns=...,
        chunksize: int | None = ...,
        dtype_backend: DtypeBackend | Literal["numpy"] = ...,
    ) -> DataFrame | Iterator[DataFrame]: ...
...
class SQLDatabase(PandasSQL):
    ...
    def __init__(
        self, con, schema: str | None = ..., need_transaction: bool = ...
    ) -> None: ...
    def __exit__(self, *args) -> None: ...
    @contextmanager
    def run_transaction(self):  # -> Generator[Connection | Any, Any, None]:
        ...

    def execute(
        self, sql: str | Select | TextClause, params=...
    ):  # -> CursorResult[Any]:
