...
@pytest.fixture
def multiindex_year_month_day_dataframe_random_data():  # -> NDFrame | Any | DataFrame | Series:
    """
...
def index(
    request,
):  # -> MultiIndex | CategoricalIndex | DatetimeIndex | Index | IntervalIndex | PeriodIndex | RangeIndex | TimedeltaIndex:
    """
...
@pytest.fixture(
    params=[
        ...
        if not isinstance(value, MultiIndex)
    ]
)
def index_flat(
    request,
...
def index_or_series_obj(
    request,
):  # -> MultiIndex | CategoricalIndex | DatetimeIndex | Index | IntervalIndex | PeriodIndex | RangeIndex | TimedeltaIndex | Series:
    """
...
def index_or_series_memory_obj(
    request,
):  # -> MultiIndex | CategoricalIndex | DatetimeIndex | Index | IntervalIndex | PeriodIndex | RangeIndex | TimedeltaIndex | Series:
    """
...
def string_dtype_no_object(request):  # -> StringDtype:
    """
    Parametrized fixture for string dtypes.
...
def pyarrow_string_dtype(request):  # -> StringDtype:
    """
...
@pytest.fixture(
    params=["python", pytest.param("pyarrow", marks=td.skip_if_no("pyarrow"))]
)
...
@pytest.fixture(
    params=["numpy_nullable", pytest.param("pyarrow", marks=td.skip_if_no("pyarrow"))]
)
...
def any_string_dtype(request):  # -> dtype[generic[Any]] | StringDtype:
    """
    Parametrized fixture for string dtypes.
    * 'object'
    * 'string[python]' (NA variant)
...
def any_skipna_inferred_dtype(request):  # -> tuple[Any, NDArray[Any]]:
    """
...
@pytest.fixture()
def arrow_string_storage():  # -> tuple[Literal['pyarrow'], Literal['pyarrow_numpy']]:
    ...
