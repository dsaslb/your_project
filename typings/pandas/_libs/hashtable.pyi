...
class Factorizer:
    ...
    def factorize(
        self, values: np.ndarray, na_sentinel=..., na_value=..., mask=...
    ) -> npt.NDArray[np.intp]: ...
...
class HashTable:
    ...
    def map_locations(
        self, values: np.ndarray, mask: npt.NDArray[np.bool_] | None = ...
    ) -> None: ...
    def lookup(
        self, values: np.ndarray, mask: npt.NDArray[np.bool_] | None = ...
    ) -> npt.NDArray[np.intp]: ...
    ...
    def unique(self, values: np.ndarray, return_inverse: bool = ..., mask=...) -> (
        tuple[
            np.ndarray,
            npt.NDArray[np.intp],
        ]
...
class Int64HashTable(HashTable):
    ...
    def map_keys_to_values(
        self, keys: npt.NDArray[np.int64], values: npt.NDArray[np.int64]
    ) -> None: ...
