...
import weakref
import numpy as np
from typing import Iterator, Sequence, final, overload
...
def get_blkno_indexers(
    blknos: np.ndarray, group: bool = ...
) -> list[tuple[int, slice | np.ndarray]]: ...
def get_blkno_placements(
    blknos: np.ndarray, group: bool = ...
) -> Iterator[tuple[int, BlockPlacement]]: ...
def update_blklocs_and_blknos(
    blklocs: npt.NDArray[np.intp], blknos: npt.NDArray[np.intp], loc: int, nblocks: int
