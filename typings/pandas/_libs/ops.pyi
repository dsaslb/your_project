...
def scalar_compare(
    values: np.ndarray, val: object, op: _BoolOp
) -> npt.NDArray[np.bool_]: ...
def vec_compare(
    left: npt.NDArray[np.object_], right: npt.NDArray[np.object_], op: _BoolOp
) -> npt.NDArray[np.bool_]: ...
...
def maybe_convert_bool(
    ...
    true_values: Iterable | None = ...,
    false_values: Iterable | None = ...,
