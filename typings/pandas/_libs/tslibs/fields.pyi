...
def get_date_field(
    dtindex: npt.NDArray[np.int64], field: str, reso: int = ...
) -> npt.NDArray[np.int32]: ...
def get_timedelta_field(
    tdindex: npt.NDArray[np.int64], field: str, reso: int = ...
) -> npt.NDArray[np.int32]: ...
def get_timedelta_days(
    tdindex: npt.NDArray[np.int64], reso: int = ...
) -> npt.NDArray[np.int64]: ...
def isleapyear_arr(years: np.ndarray) -> npt.NDArray[np.bool_]: ...
def build_isocalendar_sarray(
    dtindex: npt.NDArray[np.int64], reso: int
) -> np.ndarray: ...
...
def round_nsint64(
    values: npt.NDArray[np.int64], mode: RoundTo, nanos: int
) -> npt.NDArray[np.int64]: ...
