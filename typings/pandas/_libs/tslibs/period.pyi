...
from pandas._typing import Frequency, npt
...
def periodarr_to_dt64arr(
    periodarr: npt.NDArray[np.int64], freq: int
) -> npt.NDArray[np.int64]: ...
def period_asfreq_arr(
    arr: npt.NDArray[np.int64], freq1: int, freq2: int, end: bool
) -> npt.NDArray[np.int64]: ...
def get_period_field_arr(
    field: str, arr: npt.NDArray[np.int64], freq: int
) -> npt.NDArray[np.int64]: ...
def from_ordinals(
    values: npt.NDArray[np.int64], freq: timedelta | BaseOffset | str
) -> npt.NDArray[np.int64]: ...
def extract_ordinals(
    values: npt.NDArray[np.object_], freq: Frequency | int
) -> npt.NDArray[np.int64]: ...
def extract_freq(values: npt.NDArray[np.object_]) -> BaseOffset: ...
def period_array_strftime(
    values: npt.NDArray[np.int64], dtype_code: int, na_rep, date_format: str | None
...
class Period(PeriodMixin):
    ...
    def to_timestamp(
        self, freq: str | BaseOffset | None = ..., how: str = ...
    ) -> Timestamp: ...
