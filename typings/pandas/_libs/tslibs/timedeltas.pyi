...
from pandas._typing import Frequency, Self, npt
...
def ints_to_pytimedelta(
    m8values: npt.NDArray[np.timedelta64], box: bool = ...
) -> npt.NDArray[np.object_]: ...
def array_to_timedelta64(
    values: npt.NDArray[np.object_], unit: str | None = ..., errors: str = ...
) -> np.ndarray: ...
def parse_timedelta_unit(unit: str | None) -> UnitChoices: ...
def delta_to_nanoseconds(
    delta: np.timedelta64 | timedelta | Tick, reso: int = ..., round_ok: bool = ...
) -> int: ...
...
class Timedelta(timedelta):
    ...
    def to_numpy(
        self, dtype: npt.DTypeLike = ..., copy: bool = ...
    ) -> np.timedelta64: ...
