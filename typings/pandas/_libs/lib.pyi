...
def map_infer(
    arr: np.ndarray, f: Callable[[Any], Any], convert: bool = ..., ignore_na: bool = ...
) -> np.ndarray: ...
@overload
...
def maybe_indices_to_slice(
    indices: npt.NDArray[np.intp], max_len: int
...
def count_level_2d(
    mask: np.ndarray, labels: np.ndarray, max_bin: int
) -> np.ndarray: ...
...
def array_equivalent_object(
    left: npt.NDArray[np.object_], right: npt.NDArray[np.object_]
) -> bool: ...
