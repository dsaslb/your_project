...
from pandas.io.formats.info import INFO_DOCSTRING, frame_sub_kwargs
...
class DataFrame(NDFrame, OpsMixin):
    ...
    def __arrow_c_stream__(self, requested_schema=...):  # -> Any:
        """
    ...
    @overload
    def to_dict(
        self, orient: Literal["records"], *, into: type[dict] = ..., index: bool = ...
    ) -> list[dict]: ...
    @deprecate_nonkeyword_arguments(
    ...
    def to_records(
        self, index: bool = ..., column_dtypes=..., index_dtypes=...
    ) -> np.rec.recarray:
        """
    ...
    def __getitem__(self, key):  # -> Series | Self:
        ...
    ...
    def set_axis(
        self, labels, *, axis: Axis = ..., copy: bool | None = ...
    ) -> DataFrame: ...
    @doc(
        NDFrame.reindex,
        klass=_shared_doc_kwargs["klass"],
    ...
    def duplicated(
        self, subset: Hashable | Sequence[Hashable] | None = ..., keep: DropKeep = ...
    ) -> Series:
        """
    ...
    def nlargest(
        self, n: int, columns: IndexLabel, keep: NsmallestNlargestKeep = ...
    ) -> DataFrame:
        """
    ...
    def truediv(
        self, other, axis: Axis = ..., level=..., fill_value=...
    ) -> DataFrame: ...
    ...
    def unstack(
        self, level: IndexLabel = ..., fill_value=..., sort: bool = ...
    ):  # -> DataFrame | Series:
        """
    ...
    def aggregate(
        self, func=..., axis: Axis = ..., *args, **kwargs
    ):  # -> DataFrame | Series:
        ...
    agg = ...
    @doc(
    ...
    def count(self, axis: Axis = ..., numeric_only: bool = ...):  # -> Series | Any:
        """
    ...
    def cummin(
        self, axis: Axis | None = ..., skipna: bool = ..., *args, **kwargs
    ):  # -> Any:
        ...
    ...
    def to_period(
        self, freq: Frequency | None = ..., axis: Axis = ..., copy: bool | None = ...
    ) -> DataFrame:
        """
