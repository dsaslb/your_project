...
class BaseGrouper:
    ...
    @final
    def agg_series(
        self, obj: Series, func: Callable, preserve_dtype: bool = ...
    ) -> ArrayLike:
        """
        Parameters
        ----------
    ...
    @final
    def apply_groupwise(
        self, f: Callable, data: DataFrame | Series, axis: AxisInt = ...
    ) -> tuple[list, bool]: ...
...
class BinGrouper(BaseGrouper):
    ...
    def codes_info(self) -> npt.NDArray[np.intp]: ...
    def get_iterator(
        self, data: NDFrame, axis: AxisInt = ...
    ):  # -> Generator[tuple[Any, Any] | tuple[Any | Index, Any], Any, None]:
        """
        Groupby iterator
