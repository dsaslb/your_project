...
from pandas._typing import ArrayLike, Axis, NDFrameT, npt
...
class Grouper:
    ...
    @final
    @property
    def indexer(self):  # -> NDArray[intp] | None:
        ...

    @final
    @property
    def obj(self):  # -> NDFrameT | Series | NDFrame | None:
        ...

    @final
    @property
    def grouper(self):  # -> BaseGrouper | None:
        ...

    @final
    @property
    def groups(self):  # -> dict[Hashable, ndarray[Any, Any]]:
        ...
