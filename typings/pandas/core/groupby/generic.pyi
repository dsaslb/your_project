...
class SeriesGroupBy(GroupBy[Series]):
    ...
    def aggregate(
        self, func=..., *args, engine=..., engine_kwargs=..., **kwargs
    ):  # -> Any | DataFrame | NDFrame | Series:
        ...
    agg = ...
    ...
    def filter(
        self, func, dropna: bool = ..., *args, **kwargs
    ):  # -> NDFrame | Series | Any:
        """
    ...
    def take(
        self, indices: TakeIndexer, axis: Axis | lib.NoDefault = ..., **kwargs
    ) -> Series:
        """
    ...
    def idxmin(
        self, axis: Axis | lib.NoDefault = ..., skipna: bool = ...
    ) -> Series: ...
...
class DataFrameGroupBy(GroupBy[DataFrame]):
    ...
    def take(
        self, indices: TakeIndexer, axis: Axis | None | lib.NoDefault = ..., **kwargs
    ) -> DataFrame:
        """
        Return the elements in the given *positional* indices in each group.
