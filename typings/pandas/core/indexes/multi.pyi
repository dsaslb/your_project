...
class MultiIndex(Index):
    ...
    def from_arrays(
        ...
        arrays,
        sortorder: int | None = ...,
        names: Sequence[Hashable] | Hashable | lib.NoDefault = ...,
    ) -> MultiIndex:
        """
    ...
    def set_levels(
        self, levels, *, level=..., verify_integrity: bool = ...
    ) -> MultiIndex:
        """
    ...
    def set_codes(
        self, codes, *, level=..., verify_integrity: bool = ...
    ) -> MultiIndex:
        """
    ...
    def to_frame(
        self, index: bool = ..., name=..., allow_duplicates: bool = ...
    ) -> DataFrame:
        """
    ...
    def __reduce__(
        self,
    ):  # -> tuple[Callable[..., PeriodIndex | MultiIndex | Any], tuple[type[Self], dict[str, list[Any] | int | None]], None]:
    ...
    def argsort(
        self, *args, na_position: str = ..., **kwargs
    ) -> npt.NDArray[np.intp]: ...
    ...
    def get_slice_bound(
        self, label: Hashable | Sequence[Hashable], side: Literal["left", "right"]
    ) -> int:
        """
    ...
    def get_loc(
        self, key
    ):  # -> Any | slice[NDArray[intp] | intp, NDArray[intp] | intp, Any] | ndarray[Any, Any] | ndarray[_Shape, dtype[bool_]] | ndarray[_Shape, dtype[Any]] | slice[Any, Any, Any] | _Array1D[Any] | int | integer[Any] | slice[int, int, Any] | ndarray[tuple[int], dtype[signedinteger[_NBitIntP]]]:
        """
    ...
    def get_loc_level(
        self, key, level: IndexLabel = ..., drop_level: bool = ...
    ):  # -> tuple[int | integer[Any] | Any, tuple[Any, ...] | MultiIndex | Any]:
        """
...
def sparsify_labels(
    label_list, start: int = ..., sentinel: object = ...
):  # -> list[tuple[Any, ...]]:
    ...
