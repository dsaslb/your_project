...
class Index(IndexOpsMixin, PandasObject):
    ...
    _references = ...
    def __new__(
        cls, data=..., dtype=..., copy: bool = ..., name=..., tupleize_cols: bool = ...
    ) -> Self: ...
    @final
    ...
    def __array_ufunc__(
        self, ufunc: np.ufunc, method: str_t, *inputs, **kwargs
    ):  # -> _NotImplementedType | tuple[Any, ...] | Any | tuple[object | Index, ...] | object | Index:
        ...

    @final
    def __array_wrap__(
        self, result, context=..., return_scalar=...
    ):  # -> object | Index:
        """
    ...
    def view(
        self, cls=...
    ):  # -> DatetimeIndex | Index | TimedeltaIndex | ndarray[Any, Any] | Self | ndarray[Any, dtype[Any]] | ExtensionArray:
        ...
    ...
    def __reduce__(
        self,
    ):  # -> tuple[Callable[..., PeriodIndex | MultiIndex | Any], tuple[type[Self], dict[str, ExtensionArray | ndarray[Any, Any] | Hashable]], None]:
        ...
    ...
    def map(
        self, mapper, na_action: Literal["ignore"] | None = ...
    ):  # -> MultiIndex | Index:
        """
    ...
    def drop(
        self, labels: Index | np.ndarray | Iterable[Hashable], errors: IgnoreRaise = ...
    ) -> Index:
        """
    ...
    def any(
        self, *args, **kwargs
    ):  # -> NDArray[Any] | Any | numpy.bool[builtins.bool]:
        """
    ...
    def min(
        self, axis=..., skipna: bool = ..., *args, **kwargs
    ):  # -> NaTType | float | object | Self | NDArray[Any] | Any | str | bool | Period | Timestamp | Timedelta | Interval[Any] | datetime64[date | int | None] | timedelta64[timedelta | int | None] | date | ndarray[Any, Any]:
        """
