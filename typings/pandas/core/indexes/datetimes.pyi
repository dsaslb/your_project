...
@inherit_names(
    ["tz", "tzinfo", "dtype", "to_pydatetime", "date", "time", "timetz", "std"]
...
class DatetimeIndex(DatetimeTimedeltaMixin):
    ...
    def tz_localize(
        self, tz, ambiguous: TimeAmbiguous = ..., nonexistent: TimeNonexistent = ...
    ) -> Self: ...
    ...
    def __new__(
        cls,
        data=...,
        freq: Frequency | lib.NoDefault = ...,
        tz=...,
        normalize: bool | lib.NoDefault = ...,
        closed=...,
    ...
    def __reduce__(
        self,
    ):  # -> tuple[Callable[..., Any], tuple[type[Self], dict[str, DatetimeArray | Hashable]], None]:
        ...
    ...
    def get_loc(
        self, key
    ):  # -> slice[Any, Any, Any] | NDArray[intp] | int | ndarray[Any, Any]:
        """
    ...
    def slice_indexer(
        self, start=..., end=..., step=...
    ):  # -> NDArray[intp] | slice[Any, Any, Any] | Any:
        """
