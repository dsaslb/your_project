...
class _Unstacker:
    ...
    def __init__(
        self, index: MultiIndex, level: Level, constructor, sort: bool = ...
    ) -> None: ...
    @cache_readonly
    ...
    ):  # -> tuple[ndarray[tuple[int, int], Any], _Array[tuple[int, int], Any]] | tuple[ArrayLike | Any | ndarray[tuple[int, int], dtype[Any]], _Array[tuple[int, int], Any]]:
        ...
...
def stack(
    frame: DataFrame, level=..., dropna: bool = ..., sort: bool = ...
):  # -> DataFrame | Series:
    """
