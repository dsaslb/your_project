...
def nargminmax(
    values: ExtensionArray, method: str, axis: AxisInt = ...
):  # -> NDArray[Any] | Any | int:
    """
...
def ensure_key_mapped(
    values: ArrayLike | Index | Series, key: Callable | None, levels=...
...
def get_group_index_sorter(
    group_index: npt.NDArray[np.intp], ngroups: int | None = ...
) -> npt.NDArray[np.intp]:
    """
...
def compress_group_index(
    group_index: npt.NDArray[np.int64], sort: bool = ...
