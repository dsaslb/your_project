...
def add_ops(op_classes):  # -> Callable[..., Any]:
    """
...
class BaseExprVisitor(ast.NodeVisitor):
    ...
    def visit_Attribute(self, node, **kwargs):  # -> Constant | Term | Any:
        ...

    def visit_Call(self, node, side=..., **kwargs):  # -> MathCall | Constant | Term:
        ...
