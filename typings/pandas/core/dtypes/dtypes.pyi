...
class IntervalDtype(PandasExtensionDtype):
    ...
    **This is not an actual numpy dtype**, but a duck type.
    ...
    def __init__(
        self, subtype=..., closed: IntervalClosedType | None = ...
    ) -> None: ...
    @property
...
class ArrowDtype(StorageExtensionDtype):
    ...
    def type(
        self,
    ):  # -> type[int] | type[float] | type[str] | type[bytes] | type[bool] | type[Timedelta] | type[timedelta] | type[Timestamp] | type[datetime] | type[date] | type[time] | type[Decimal] | type[CategoricalDtypeType] | type[list[Any]] | type[dict[Any, Any]] | type[Any]:
        """
