...
def maybe_downcast_numeric(
    result: np.ndarray, dtype: np.dtype, do_round: bool = ...
) -> np.ndarray: ...
@overload
def maybe_downcast_numeric(
    result: ExtensionArray, dtype: DtypeObj, do_round: bool = ...
) -> ArrayLike: ...
def maybe_downcast_numeric(
...
):  # -> tuple[dtype[Any], DTScalarOrNaT | float | object | Any | int64 | datetime64[date | int | None] | timedelta64[timedelta | int | None] | ndarray[Any, Any] | bool | bool_ | int | integer[Any] | complex]:
    """
...
def maybe_infer_to_datetimelike(
    value: npt.NDArray[np.object_], convert_to_nullable_dtype: bool = ...
