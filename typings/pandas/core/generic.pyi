...
class NDFrame(PandasObject, indexing.IndexingMixin):
    ...
    @final
    def set_flags(
        self, *, copy: bool_t = ..., allows_duplicate_labels: bool_t | None = ...
    ) -> Self:
        """
    ...
    def __array__(
        self, dtype: npt.DTypeLike | None = ..., copy: bool_t | None = ...
    ) -> np.ndarray: ...
    @final
    def __array_ufunc__(
        self, ufunc: np.ufunc, method: str, *inputs: Any, **kwargs: Any
    ):  # -> _NotImplementedType | tuple[Any, ...] | Any:
        ...
    ...
    @final
    def astype(
        self, dtype, copy: bool_t | None = ..., errors: IgnoreRaise = ...
    ) -> Self:
        """
    ...
    def asof(
        self, where, subset=...
    ):  # -> Any | float | ndarray[_Shape, Any] | Series | DataFrame | Self:
        """
    ...
    @final
    def truncate(
        self, before=..., after=..., axis: Axis | None = ..., copy: bool_t | None = ...
    ) -> Self:
        """
    ...
    @doc(klass=_shared_doc_kwargs["klass"])
    def tz_convert(
        self, tz, axis: Axis = ..., level=..., copy: bool_t | None = ...
    ) -> Self:
        """
    ...
    def all(
        self, axis: Axis = ..., bool_only: bool_t = ..., skipna: bool_t = ..., **kwargs
    ) -> Series | bool_t: ...
    def cummax(
        self, axis: Axis | None = ..., skipna: bool_t = ..., *args, **kwargs
    ):  # -> Any:
        ...
