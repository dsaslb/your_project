...
class BaseBlockManager(DataManager):
    ...
    def get_values_for_csv(
        self, *, float_format, date_format, decimal, na_rep: str = ..., quoting=...
    ) -> Self:
        """
    ...
    def take(
        self, indexer: npt.NDArray[np.intp], axis: AxisInt = ..., verify: bool = ...
    ) -> Self:
        """
...
class BlockManager(libinternals.BlockManager, BaseBlockManager):
    ...
    def column_setitem(
        self, loc: int, idx: int | slice | np.ndarray, value, inplace_only: bool = ...
    ) -> None:
        """
    ...
    def quantile(
        self, *, qs: Index, interpolation: QuantileInterpolation = ...
    ) -> Self:
        """
    ...
    def as_array(
        self, dtype: np.dtype | None = ..., copy: bool = ..., na_value: object = ...
    ) -> np.ndarray:
        """
...
class SingleBlockManager(BaseBlockManager, SingleDataManager):
    ...
    is_single_block = ...
    def __init__(
        self, block: Block, axis: Index, verify_integrity: bool = ...
    ) -> None: ...
    @classmethod
    def from_blocks(cls, blocks: list[Block], axes: list[Index]) -> Self:
        """
    ...
    @classmethod
    def from_array(
        cls, array: ArrayLike, index: Index, refs: BlockValuesRefs | None = ...
    ) -> SingleBlockManager:
        """
    ...
    def __getstate__(
        self,
    ):  # -> tuple[list[Index], list[ndarray[Any, Any] | ExtensionArray], list[Any | Index], dict[str, dict[str, list[Index] | list[dict[str, ndarray[Any, Any] | ExtensionArray | slice[Any, Any, Any]]]]]]:
        ...
...
def create_block_manager_from_column_arrays(
    arrays: list[ArrayLike], axes: list[Index], consolidate: bool, refs: list
) -> BlockManager: ...
