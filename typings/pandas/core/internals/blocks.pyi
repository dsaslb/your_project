...
class Block(PandasObject, libinternals.Block):
    ...
    def getitem_block_columns(
        self, slicer: slice, new_mgr_locs: BlockPlacement, ref_inplace_op: bool = ...
    ) -> Self:
        """
        Perform __getitem__-like, return result as block.
    ...
    def coerce_to_target_dtype(
        self, other, warn_on_upcast: bool = ..., using_cow: bool = ...
    ) -> Block:
        """
    ...
    @final
    def convert(
        self, *, copy: bool = ..., using_cow: bool = ..., convert_string: bool = ...
    ) -> list[Block]:
        """
    ...
    def putmask(
        self, mask, new, using_cow: bool = ..., already_warned=...
    ) -> list[Block]:
        """
    ...
    def where(
        self, other, cond, _downcast: str | bool = ..., using_cow: bool = ...
    ) -> list[Block]:
        """
...
def new_block_2d(
    values: ArrayLike, placement: BlockPlacement, refs: BlockValuesRefs | None = ...
):  # -> Block:
    ...

def new_block(
    values, placement: BlockPlacement, *, ndim: int, refs: BlockValuesRefs | None = ...
) -> Block: ...
