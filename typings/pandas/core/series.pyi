...
class Series(base.IndexOpsMixin, NDFrame):
    ...
    def __getitem__(
        self, key
    ):  # -> Self | Any | ndarray[_Shape, Any] | Series | NDArray[Any]:
        ...
    ...
    def swaplevel(
        self, i: Level = ..., j: Level = ..., copy: bool | None = ...
    ) -> Series:
        """
    ...
    def between(
        self, left, right, inclusive: Literal["both", "neither", "left", "right"] = ...
    ) -> Series:
        """
    ...
    def rtruediv(
        self, other, level=..., fill_value=..., axis: Axis = ...
    ) -> Series: ...
    ...
    def any(
        self, *, axis: Axis = ..., bool_only: bool = ..., skipna: bool = ..., **kwargs
    ) -> bool: ...
