...
class StringDtype(StorageExtensionDtype):
    ...
    _metadata = ...
    def __init__(
        self, storage: str | None = ..., na_value: libmissing.NAType | float = ...
    ) -> None: ...
    ...
    def __reduce__(
        self,
    ):  # -> tuple[type[StringDtype], tuple[str | Any, NAType | float]]:
        ...
...
class StringArray(BaseStringArray, NumpyExtensionArray):
    ...
    ):  # -> Self | IntegerArray | FloatingArray | ExtensionArray | ndarray[Any, dtype[Any]] | ndarray[Any, Any]:
        ...
