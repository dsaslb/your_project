...
class SparseArray(OpsMixin, PandasObject, ExtensionArray):
    ...
    def __getitem__(
        self, key: PositionalIndexer | tuple[int | ellipsis, ...]
    ) -> Self | Any: ...
    ...
    def copy(self) -> Self: ...
    def astype(
        self, dtype: AstypeArg | None = ..., copy: bool = ...
    ...
    ):  # -> numpy.bool[builtins.bool] | Literal[False]:
        """
    ...
    ):  # -> _NotImplementedType | tuple[Any, ...] | Any | tuple[Self, ...] | Self | None:
        ...
    _logical_method = ...
