...
class DatetimeArray(dtl.TimelikeOps, dtl.DatelikeOps):
    ...
    ):  # -> Self | NDArray[object_] | ndarray[tuple[int, ...], Any] | ExtensionArray | NDArray[int64] | NDArray[Any] | PeriodArray:
        ...
...
def objects_to_datetime64(
    ...
    allow_object: bool = ...,
    out_unit: str = ...,
):  # -> tuple[ndarray[Any, Any], tzinfo] | tuple[ndarray[Any, Any], None]:
    """
...
def maybe_convert_dtype(
    data, copy: bool, tz: tzinfo | None = ...
):  # -> tuple[Any, bool] | tuple[Any | NDArray[object_], bool]:
    """
