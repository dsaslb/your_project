...
from pandas._typing import Axis, TimedeltaConvertibleTypes
...
class ExponentialMovingWindow(BaseWindow):
    ...
    **times**
    ...
    def __init__(
        ...
        ignore_na: bool = ...,
        axis: Axis = ...,
        times: np.ndarray | NDFrame | None = ...,
        method: str = ...,
        *,
        selection=...
    ) -> None: ...
    def online(
        self, engine: str = ..., engine_kwargs=...
    ...
    def mean(
        self, numeric_only: bool = ..., engine=..., engine_kwargs=...
    ):  # -> DataFrame | Series:
        ...
...
class OnlineExponentialMovingWindow(ExponentialMovingWindow):
    ...
    def mean(self, *args, update=..., update_times=..., **kwargs):  # -> Series:
        """
