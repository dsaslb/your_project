...
class StringMethods(NoNewAttributesMixin):
    ...
    def __getitem__(
        self, key
    ):  # -> DataFrame | dict[int, ArrowExtensionArray] | list[Any | list[Any]] | Index | MultiIndex | Series:
        ...

    def __iter__(self) -> Iterator: ...
    @forbid_nonstring_types(["bytes", "mixed", "mixed-integer"])
    def cat(
        self, others=..., sep: str | None = ..., na_rep=..., join: AlignJoin = ...
    ) -> str | Series | Index:
        """
    ...
    @forbid_nonstring_types(["bytes"])
    def match(
        self, pat: str, case: bool = ..., flags: int = ..., na=...
    ):  # -> DataFrame | dict[int, ArrowExtensionArray] | list[Any | list[Any]] | Index | MultiIndex | Series:
        """
    ...
    @forbid_nonstring_types(["bytes"])
    def fullmatch(
        self, pat, case: bool = ..., flags: int = ..., na=...
    ):  # -> DataFrame | dict[int, ArrowExtensionArray] | list[Any | list[Any]] | Index | MultiIndex | Series:
        """
    ...
    def decode(
        self, encoding, errors: str = ..., dtype: str | DtypeObj | None = ...
    ):  # -> DataFrame | dict[int, ArrowExtensionArray] | list[Any | list[Any]] | Index | MultiIndex | Series:
        """
    ...
    @forbid_nonstring_types(["bytes"])
    def startswith(
        self, pat: str | tuple[str, ...], na: Scalar | lib.NoDefault = ...
    ) -> Series | Index:
        """
    ...
    @forbid_nonstring_types(["bytes"])
    def extractall(self, pat, flags: int = ...) -> DataFrame:
        r"""
...
def cat_safe(list_of_columns: list[npt.NDArray[np.object_]], sep: str):  # -> Any:
    """
...
def str_extractall(arr, pat, flags: int = ...) -> DataFrame: ...
